    ...
    return (
        <div className={styles.port}>
            <a href={link} target="_blank">
                <figure className={styles.port__header}>
                    <Image width={500} height={500} src={portImg} alt={title} />
                </figure>
                <div className={styles.port__body}>
                    <span>
                        <Image
                            width={60}
                            height={60}
...
function PortSection() {
    ...
    return (
        <section
            id="portSection"
            className="port__wrap gmarket5 section center"
        >
            <h3>{portTitle.title}</h3>
            <p>{portTitle.desc}</p>
            <div className={`${styles.port__inner} container`}>
                <div className={styles.port__btn}>
                    <button
                        className={
                ...
                <div className={styles.port__cont2}>
